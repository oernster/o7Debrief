...
A local-first Windows desktop application that reads the Elite Dangerous player Journal and produces a Commander Mission Debrief report at the end of a play session.
